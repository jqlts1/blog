...
class Article(models.Model):
    ...
    # en_title = models.CharField(max_length=100, verbose_name=u'英文标题',null=True, blank=True) #如果有英文标题用英文标题,如果没有就用id
    ...
    #如果有英文标题就用英文,没有就用id作为标题
    # def get_en(self):
    #     if self.en_title == '':
    #         return self.pk
    #     else:
    #         return '%s_%s' % (self.en_title,self.pk)
